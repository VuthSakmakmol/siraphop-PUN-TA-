<template>
    <v-container>
      <v-card class="pa-6" elevation="4">
        ...
        <v-card-text>
          <v-row dense>
            <v-col cols="12" md="4"><strong>Full Name:</strong> {{ candidate.fullName }}</v-col>
            <v-col cols="12" md="4"><strong>Source:</strong> {{ candidate.applicationSource }}</v-col>
            <v-col cols="12" md="4"><strong>Hire Decision:</strong> {{ candidate.hireDecision || '-' }}</v-col>
            <v-col cols="12" md="4"><strong>Applied Job:</strong> {{ candidate.jobRequisitionId?.jobTitle || '-' }}</v-col>
